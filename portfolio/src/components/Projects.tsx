...
const PROJECTS: Project[] = [
  {
    ...
    role: "Full-stack",
    context:
      "Plateforme cinématographique avec gestion utilisateur, avis critiques et interface d'administration complète.",
    ...
    challenges:
      "Gestion de l'authentification et synchronisation temps réel des avis.",
  ...
  },
  {
    ...
    role: "Frontend",
    context:
      "Plateforme vitrine pour une structure d'accompagnement business et conseil stratégique.",
...

  {
    ...
    role: "Frontend",
    context:
      "Application web de gestion de notes développée avec Vue.js, permettant de créer, consulter, modifier et gérer des Post-it avec une persistance locale puis via une API.",
    technologies: [
      "Vue.js",
      "Vue Router",
      "Pinia",
    ...
    features: [
      "Création et gestion de Post-it",
      "Consultation détaillée d'une note",
    ...
    challenges:
      "Mettre en place une architecture Vue.js permettant de gérer efficacement les données entre les composants, puis faire évoluer la persistance de LocalStorage vers une API distante avec Vuex.",
    result:
      "Application de gestion de notes fonctionnelle, structurée autour des composants Vue.js et capable de synchroniser les données avec une API.",
    githubUrl: "https://github.com/esmonEpitech/Post-it",
    demoUrl: "https://post-it-pied.vercel.app/",
    image:
...

  {
    ...
    role: "Mobile",
    context:
      "Application de gestion de tâches inspirée de Trello utilisant l'API officielle pour synchroniser les boards.",
    ...
    challenges:
      "Optimisation des performances sur mobile avec de longues listes de cartes.",
  ...
  },
  {
    ...
    role: "Frontend",
    context:
      "Solution de billetterie événementielle spécialisée dans les concerts avec génération de QR codes.",
  ...
  },
  {
    ...
    role: "Full-stack",
    context:
      "Application collaborative permettant d'ajouter des avis et commentaires sur n'importe quel site web.",
    ...
    challenges:
      "Gestion des relations complexes en base de données (User/Post/Comment).",
      ...
      >
        ...
        <div className="flex gap-3 mt-4">
          {project.technologies.slice(0, 3).map((t) => (
            <span
              key={t}
              className="text-[10px] text-app-text-muted font-medium"
            >
              #{t}
            </span>
          ))}
