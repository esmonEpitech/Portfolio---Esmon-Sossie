...
export default function ExperienceTimeline() {
  const timeline = [
    {
      ...
      accent: "brand-orange",
      description:
        "Formation orientée projets pratiques en développement full-stack moderne. Accent sur la création d’applications complètes et déploiement.",
    },
    {
  ...
  return (
    <section
      id="journey"
      className="py-24 px-4 md:px-8 bg-app-bg/40 relative overflow-hidden"
    >
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-1/2 w-12 h-12 -translate-x-1/2 flex items-center justify-center z-20">
                    ...
                    >
                      <Icon
                        className={`w-5 h-5 ${item.status ? "text-brand-orange animate-pulse" : "text-brand-blue"}`}
                      />
                    </motion.div>
                  </div>
                  ...
                  {/* CARD */}
                  <div
                    className={`w-full md:w-[42%] ml-14 md:ml-0 ${isEven ? "md:pr-12" : "md:pl-12"}`}
                  >
                    <motion.div
                      whileHover={{ y: -8 }}
                    ...
                    >
                      ...
                      <div
                        className={`absolute bottom-4 right-6 w-8 h-8 opacity-10 group-hover:opacity-100 transition-opacity`}
                      >
                        <Icon
                          size={32}
                          className={
